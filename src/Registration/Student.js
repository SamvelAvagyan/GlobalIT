...
import vector from "../Components/Facultets/img/eye.svg";
            ...
            <div className="container">
                ...
                <form>
                    ...
                    <div className="pass_div">
                        <input type={passShow ? "text" : "password"} placeholder="Գաղտնաբառ" onChange={change} className = "pass_inp"></input>
                        {/* <img src = {vector} onClick = {passToggle} className = "pass_show"></img> */}
                    </div>
